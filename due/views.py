...
from due.models import AnaliseDocumento, DueDiligence, TypeUserChoices
from due.permissions import (
    IsAdmin,
    IsAdminBrokerOrAdvogado,
    IsAdminOrAdvogado,
    IsBrokerOrAdmin,
)
from due.serializer import (
    AnaliseDocumentoSerializer,
    AnaliseDocumentoUpdateSerializer,
    DueDiligenceCreateSerializer,
...
@extend_schema(
    ...
    responses={
        ...
        403: OpenApiResponse(
            description="Somente Admin ou Advogados podem realizar esta ação."
        ),
    },
)
...
@extend_schema(
    ...
    responses={
        ...
        404: OpenApiResponse(description="Diligencia não localizada na base."),
    },
)
class DueUpdateView(generics.UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                {"message": "Erro de validação", "erros": e.detail},
        ...
        400: OpenApiResponse(
            ...
            examples=[
                OpenApiExample(
                    ...
                    value={"precatorio": ["Esse precatório já esta em diligencia."]},
                )
            ],
        ),
    },
...
class DueCreateView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                {"message": "Erro de validação", "errors": e.detail},
                status=status.HTTP_400_BAD_REQUEST,
            )
            ...
            return Response(
                {
                    ...
                    "errors": {
                        "precatorio": [
                            "Já existe uma Due Diligence ativa para este precatório."
                        ]
                    },
                },
                status=status.HTTP_400_BAD_REQUEST,
...
class AnaliseDocumentoListView(APIView):
    ...
    def get(self, request):
        ...
        if user.type_user == TypeUserChoices.ADMINISTRADOR:
            queryset
        if (
            user.type_user == TypeUserChoices.ADVOGADO
            or user.type_user == TypeUserChoices.BROKER
        ):
...
@extend_schema(
    ...
    responses={
        ...
        403: OpenApiResponse(
            description="Somento o dono desse ativo pode realizar edições."
        ),
    },
)
class AnaliseDocumentoUpdateView(APIView):
    ...
    def patch(self, request, pk):
        ...
        queryset = get_object_or_404(
            AnaliseDocumento.objects.select_related(
        ...
        serializer = AnaliseDocumentoSerializer(
            instance=queryset,
            data=request.data,
            partial=True,
