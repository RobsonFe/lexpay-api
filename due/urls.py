...
urlpatterns = [
    path(
        "diligencias/",
        DueDiligenceListCreateView.as_view(),
        name="diligence-list-create",
    ),
    path(
        "diligencias/<uuid:pk>/",
        DueDiligenceRetrieveUpdateView.as_view(),
        name="diligence-detail-update",
    ),
    ...
    path(
        "listar/documentos/", AnaliseDocumentoListView.as_view(), name="documento-list"
    ),
    path(
        "atualizar/documentos/<uuid:pk>/",
        AnaliseDocumentoUpdateView.as_view(),
        name="analise-documento-update",
    ),
]
