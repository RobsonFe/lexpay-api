...
from .views import (AnaliseDocumentoListView, AnaliseDocumentoUpdateView,
                    DueCreateView, DueDiligenceListCreateView,
                    DueDiligenceRetrieveUpdateView, DueListPrioridadeView,
                    DueListView, DueUpdateView)
